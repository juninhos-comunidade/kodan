...
const challenges: Challenge[] = [
  { id: "effect-1", title: "Cleanup de WebSocket", difficulty: "MEDIUM", recommendedElo: 1200, tags: "React,useEffect,cleanup", attempts: [{ id: "a1", score: 7 }] },
  { id: "state-1", title: "Estado derivado", difficulty: "EASY", recommendedElo: 900, tags: "React,state,rendering", attempts: [] },
  { id: "perf-1", title: "Memoização seletiva", difficulty: "HARD", recommendedElo: 1600, tags: "React,useMemo,advanced", attempts: [{ id: "a2", score: 3 }] },
];
...
export const NavegacaoEmArvore: Story = { render: () => <div className="challengers-panel w-80 border p-4"><ChallengesNavigationTree sections={sections} topicFilter="ALL" filterDifficulty="ALL" density="desktop" onTopicChange={fn()} onDifficultyChange={fn()} /></div> };
...
export const ShellMobile: Story = { parameters: { viewport: { defaultViewport: "mobile1" } }, render: () => <ChallengesMobileShell userElo={1460} user={user} searchQuery="" filtersOpen={false} onSearchChange={fn()} onOpenFilters={fn()}><ChallengesStatePanel title="Desafios" description="Conteúdo do catálogo no layout móvel." /></ChallengesMobileShell> };
